function showTime() { 
	...
	var startDate = new Date(2018, 08, 30);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "honey:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----黄摇   2019-11-02</c>"; 
